...
$pageTitle = __('loans');
$pageDescription = 'Kelola pinjaman anggota koperasi';
$showAddButton = true;
$addButtonText = __('add_loan');
...
<div class="page-header mb-4">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-primary" onclick="alert('Fitur tambah pinjaman segera hadir')">
...
<div class="page-content">
    <div class="alert alert-info">
        ...
        <?php echo __('coming_soon'); ?> - Halaman pinjaman sedang dalam pengembangan.
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center py-5">
                ...
                <p class="text-muted mt-3">Belum ada data pinjaman</p>
                <button class="btn btn-primary" onclick="alert('Fitur tambah pinjaman segera hadir')">
                    <i class="bi bi-plus-circle me-2"></i>Tambah Pinjaman Pertama
                </button>
            </div>
        </div>
    </div>
